...
export async function GET(req: NextRequest) {
  ...
  if (acceso && acceso.tiene_acceso) {
    ...
    await syncTenantAccess(supabaseAdmin, acceso.ret_org_id, acceso.plan, acceso.dias_restantes)
...
export async function POST(req: NextRequest) {
  ...
  if (acceso && acceso.tiene_acceso) {
    ...
    await syncTenantAccess(supabaseAdmin, orgId, acceso.plan, acceso.dias_restantes)
    return NextResponse.json({ esColab: false, acceso })
  }
